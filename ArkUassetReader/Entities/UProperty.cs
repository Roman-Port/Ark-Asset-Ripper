...
namespace ArkUassetReader.Entities
{
    public class UProperty
    {
        ...
        public UProperty(IOMemoryStream ms, UAssetFile f, bool isArray)
        {
        ...
        public static UProperty ReadAnyProp(IOMemoryStream ms, UAssetFile f, out List<string> warnings, bool isArray = false, string arrayType = null)
        {
            ...
            switch(type)
            {
                case "ArrayProperty": u = new ArrayProperty(ms, f, isArray); break; //Working, but does not read data
                case "BoolProperty": u = new BoolProperty(ms, f, isArray); break;
                case "ByteProperty": u = new ByteProperty(ms, f, isArray); break; //TODO
                ...
                case "ObjectProperty": u = new ObjectProperty(ms, f, isArray); break; //Working, but does not read data
                case "StrProperty": u = new StrProperty(ms, f, isArray); break;
                case "StructProperty": u = new StructProperty(ms, f, isArray); break; //TODO
                ...
                default:
                    ...
                    warnings.Add($"WARNING! Unknown type '{type}'. Skipping... This will likely cause a crash! Name: {name_string}");
                    u = new PlaceholderProperty(ms, f, isArray);
                    break;
            }
            return u;
        }
